...
# the group that person i is in. For example, if groupSizes[1] = 3,
...
# group. If there are multiple answers, return any of them.
...
# The second group is [0,1,2]. The size is 3,
# and groupSizes[0] = groupSizes[1] = groupSizes[2] = 3.
# The third group is [3,4,6]. The size is 3,
# and groupSizes[3] = groupSizes[4] = groupSizes[6] = 3.
